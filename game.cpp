...
/* toDo:
 *
 * when checking nodes there is a mistake: you need to check the node you
 * want to explore for being blocked, not the current node
 *
 */
...
void Game::start_DepthFirstSearch()
{
...
void Game::call_DepthFirstSearch()
{
    ++loopCount;
...
void Game::start_BreadthFirstSearch()
{
    start = nodes[menu->lastStartCol][menu->lastStartRow];
    finish = nodes[menu->lastFinishCol][menu->lastFinishRow];
...
void Game::call_BreadthFirstSearch()
{
    ++loopCount;
...
void Game::start_BestFirstSearch()
{
    start = nodes[menu->lastStartCol][menu->lastStartRow];
    finish = nodes[menu->lastFinishCol][menu->lastFinishRow];
...
void Game::call_BestFirstSearch()
{
    ++loopCount;
